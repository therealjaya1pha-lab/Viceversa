...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-[#1E293B] text-white">
      ...
      <div className="layout-container section-spacing-md">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="space-y-4">
            ...
            <div className="pt-2">
              ...
              <a
                ...
                className="inline-flex items-center space-x-2 text-sm text-slate-300 hover:text-white transition-colors group"
              >
                <div className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center group-hover:bg-[#9C1D38] transition-colors shadow-xs">
                  <Facebook className="w-4 h-4 fill-current text-white" />
                </div>
                <span className="font-medium">@Vice Versa Speech</span>
              </a>
            </div>
          </div>
          ...
          <div className="space-y-3">
            <h3 className="text-base font-bold text-white tracking-wide border-b border-slate-700/80 pb-2">
              {isEs ? 'Información de Contacto:' : 'Contact Info:'}
            </h3>
            <ul className="space-y-2.5 text-sm text-slate-300">
              <li className="flex items-start space-x-2.5">
                <Phone className="w-4 h-4 text-rose-400 mt-0.5 shrink-0" />
                <a href="tel:4693201700" className="hover:text-white font-medium transition-colors">
                  469-320-1700
                </a>
              </li>
              <li className="flex items-start space-x-2.5">
                <Printer className="w-4 h-4 text-slate-400 mt-0.5 shrink-0" />
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-sm text-slate-300">
              <li>
                <Link href="/about" className="hover:text-rose-300 transition-colors">
              ...
              <li>
                <Link href="/insurance" className="hover:text-rose-300 transition-colors">
                  {isEs ? 'Seguros Aceptados' : 'Insurance'}
                </Link>
              </li>
              <li>
                <Link href="/empower" className="hover:text-rose-300 transition-colors">
                  {isEs ? 'Programas Empower' : 'Empower Programs'}
                </Link>
              </li>
              <li>
                <Link href="/nannies" className="hover:text-rose-300 transition-colors">
                  {isEs ? 'Language of Learning Nannies' : 'Nannies (LOLN)'}
                </Link>
              </li>
              <li>
                <Link href="/employment" className="hover:text-rose-300 transition-colors">
      ...
      <div className="bg-gradient-to-r from-[#7A1429] via-[#9C1D38] to-[#86172E] py-3 text-center text-xs text-white/95 font-medium shadow-inner">
        <div className="max-w-7xl mx-auto px-4 flex flex-col sm:flex-row items-center justify-between gap-2">
          <span>Copyright © 2026 by Vice Versa. All Rights Reserved.</span>
          <span className="flex items-center space-x-1 text-rose-100">
