      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#9C1D38] leading-tight font-serif">
              {isEs
            ...
            <div className="pt-2">
              <Link
                href="/about"
                className="inline-block bg-[#9C1D38] hover:bg-[#7A1429] text-white px-8 py-3.5 rounded-full text-xs font-bold uppercase tracking-wider transition-all shadow-md hover:shadow-lg"
              >
          ...
          {/* Right Image Column with Grey Frame Overlay */}
          <div className="lg:col-span-5 relative">
            <div className="relative mx-auto max-w-md lg:max-w-none">
              {/* Offset Background Accent Box */}
              <div className="absolute top-6 left-6 -bottom-6 -right-6 bg-[#6B7280]/20 rounded-2xl z-0" />
              {/* Main Image */}
